...
-- Captains
('John', 'Smith', 'Captain', 'IST', '2015-03-15', TRUE),
('Sarah', 'Johnson', 'Captain', 'IST', '2014-08-20', TRUE),
('Michael', 'Williams', 'Captain', 'LHR', '2013-11-05', TRUE),
('Emma', 'Brown', 'Captain', 'FRA', '2012-06-10', TRUE),
('Robert', 'Jones', 'Captain', 'CDG', '2015-01-22', TRUE),

-- First Officers
('David', 'Miller', 'First Officer', 'IST', '2016-04-12', TRUE),
('Lisa', 'Davis', 'First Officer', 'IST', '2017-09-08', TRUE),
('James', 'Wilson', 'First Officer', 'LHR', '2016-07-14', TRUE),
('Anna', 'Moore', 'First Officer', 'FRA', '2018-02-28', TRUE),
('Thomas', 'Taylor', 'First Officer', 'CDG', '2017-05-19', TRUE),

-- Flight Attendants (30 people)
('Maria', 'Garcia', 'Flight Attendant', 'IST', '2018-01-10', TRUE),
('Carlos', 'Rodriguez', 'Flight Attendant', 'IST', '2019-03-15', TRUE),
('Sophie', 'Martin', 'Flight Attendant', 'IST', '2018-06-20', TRUE),
('Nicolas', 'Dubois', 'Flight Attendant', 'LHR', '2019-02-14', TRUE),
('Isabella', 'Rossi', 'Flight Attendant', 'LHR', '2018-09-07', TRUE),
('Antonio', 'Conti', 'Flight Attendant', 'FRA', '2019-04-11', TRUE),
('Elena', 'Moretti', 'Flight Attendant', 'FRA', '2018-08-22', TRUE),
('Paulo', 'Santos', 'Flight Attendant', 'FRA', '2019-05-30', TRUE),
('Francoise', 'Blanc', 'Flight Attendant', 'CDG', '2018-10-15', TRUE),
('Laurent', 'Petit', 'Flight Attendant', 'CDG', '2019-01-20', TRUE),
('Giulia', 'Ferrari', 'Flight Attendant', 'IST', '2018-11-05', TRUE),
('Marco', 'Bianchi', 'Flight Attendant', 'IST', '2019-06-08', TRUE),
('Hannah', 'Mueller', 'Flight Attendant', 'LHR', '2018-12-03', TRUE),
('Klaus', 'Schmidt', 'Flight Attendant', 'LHR', '2019-07-12', TRUE),
('Ingrid', 'Weber', 'Flight Attendant', 'FRA', '2018-07-25', TRUE),
('Hans', 'Fischer', 'Flight Attendant', 'FRA', '2019-08-19', TRUE),
('Annette', 'Koch', 'Flight Attendant', 'CDG', '2018-09-30', TRUE),
('Wilhelm', 'Hoffmann', 'Flight Attendant', 'CDG', '2019-09-14', TRUE),
('Yuki', 'Tanaka', 'Flight Attendant', 'IST', '2018-04-16', TRUE),
('Kenji', 'Yamamoto', 'Flight Attendant', 'IST', '2019-10-22', TRUE),
('Anna', 'Kowalski', 'Flight Attendant', 'LHR', '2018-05-11', TRUE),
('Piotr', 'Nowak', 'Flight Attendant', 'LHR', '2019-11-05', TRUE),
('Dimitri', 'Petrov', 'Flight Attendant', 'FRA', '2018-02-28', TRUE),
('Natasha', 'Sokolov', 'Flight Attendant', 'FRA', '2019-12-10', TRUE),
('Katarina', 'Horvath', 'Flight Attendant', 'CDG', '2018-03-19', TRUE),
('Stefan', 'Novak', 'Flight Attendant', 'CDG', '2020-01-15', TRUE),

-- Pursers
('Amanda', 'Thompson', 'Purser', 'IST', '2017-02-14', TRUE),
('Richard', 'Anderson', 'Purser', 'LHR', '2016-09-09', TRUE),
('Jennifer', 'Thomas', 'Purser', 'FRA', '2017-11-22', TRUE),
('Christopher', 'Jackson', 'Purser', 'CDG', '2018-04-05', TRUE);
